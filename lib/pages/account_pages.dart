    ...
    return Container(
        ...
        child: TextFormField(
          ...
          decoration: InputDecoration(
            border:
                OutlineInputBorder(borderRadius: BorderRadius.circular(15.0)),
            icon: Icon(Icons.tag, color: Colors.red[400]),
    ...
    return Container(
        ...
        child: TextFormField(
          ...
          decoration: InputDecoration(
            border:
                OutlineInputBorder(borderRadius: BorderRadius.circular(15.0)),
            icon: Icon(Icons.phone, color: Colors.red[400]),
  ...
  Widget _createCityDropdown(size) {
    return Container(
      child: Row(
        children: <Widget>[
          SizedBox(width: 10.0),
          Icon(Icons.room_rounded, color: Colors.red[400]),
          SizedBox(width: 15.0),
          Container(
    ...
    return Container(
        ...
        child: TextFormField(
          ...
          decoration: InputDecoration(
            border:
                OutlineInputBorder(borderRadius: BorderRadius.circular(15.0)),
            icon: Icon(Icons.calendar_today, color: Colors.red[400]),
